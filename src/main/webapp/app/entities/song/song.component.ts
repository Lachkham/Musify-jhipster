...
export class SongComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.songService
      ...
      .subscribe(
        (res: HttpResponse<ISong[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSongs(): void {
    this.eventSubscriber = this.eventManager.subscribe('songListModification', () => this.loadPage());
  }
